...
namespace GenshinCalculator.Controllers
{
    public class WeaponsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Rarity,ImagePath,WeaponType")] Weapon weapon)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Rarity,ImagePath,WeaponType")] Weapon weapon)
        {
            if (id != weapon.Id)
            {
                return NotFound();
