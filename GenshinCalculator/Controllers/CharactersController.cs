...
namespace GenshinCalculator.Controllers
{
    public class CharactersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Fullname,AvatarPath,Rarity,Description,DayOfBirth")] Character character)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Fullname,AvatarPath,Rarity,Description,DayOfBirth")] Character character)
        {
            if (id != character.Id)
            {
                return NotFound();
